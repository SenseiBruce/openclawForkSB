...
required = {
    ...
    "FIRECRAWL_BASE_URL",
    "GITHUB_ACTIONS",
    "CLAWDBOT_DISCORD_SMOKE_AGENT",
    "CLAWDBOT_DISCORD_SMOKE_CHANNEL_ID",
    "CLAWDBOT_DISCORD_SMOKE_DRIVER",
    "CLAWDBOT_DISCORD_SMOKE_DRIVER_TOKEN",
    "CLAWDBOT_DISCORD_SMOKE_INSTRUCTION",
    "CLAWDBOT_DISCORD_SMOKE_MENTION_USER_ID",
}
